    ...
    <main className="min-h-screen bg-gradient-to-br from-pink-200 via-white to-pink-100 p-16 flex flex-col items-center overflow-hidden">
        ...
        <section className="flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto mb-16 relative bg-pink-50 p-8 rounded-xl shadow-lg">
          <div className="text-center md:text-left mb-12 md:mb-0">
            <h1 className="text-6xl font-extrabold text-pink-600 mb-6 animate__animated animate__fadeIn">
              Services That Redefine Beauty
            </h1>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed animate__animated animate__fadeIn animate__delay-1s">
        ...
        <section className="w-full relative bg-gradient-to-r from-pink-300 to-purple-300 py-16 text-center">
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-white">
            <h2 className="text-6xl font-extrabold mb-4">Our Mission</h2>
        ...
        <section className="mt-16 max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="p-8 bg-gradient-to-br from-pink-100 to-white rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition-transform duration-300 ease-in-out relative">
              ...
              <h3 className="text-3xl font-bold text-purple-600 mb-4">Glow Skincare</h3>
            ...
            <div className="p-8 bg-gradient-to-br from-pink-100 to-white rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition-transform duration-300 ease-in-out relative">
              ...
              <h3 className="text-3xl font-bold text-purple-600 mb-4">Wellness Coaching</h3>
              <p className="text-gray-600 text-lg">
            ...
            <div className="p-8 bg-gradient-to-br from-pink-100 to-white rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition-transform duration-300 ease-in-out relative">
              ...
              <h3 className="text-3xl font-bold text-purple-600 mb-4">Lifestyle Collection</h3>
              <p className="text-gray-600 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center">
            ...
            <div className="flex justify-center">
              <Link href="/component/booking">
                <button className="bg-white text-pink-600 py-6 px-12 rounded-lg shadow-lg hover:bg-pink-100 hover:scale-110 transition-transform duration-300 ease-in-out">
                  Book Now
                </button>
              </Link>
            </div>
